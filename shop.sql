...
(10001, '分类1', 10001, 0, 100, 10001, 1563680163, 1563680689),
(10002, '分类2', 0, 10001, 100, 10001, 1563680171, 1563680802),
(10003, '分类1', 0, 0, 100, 10001, 1563680729, 1563680729),
(10004, '子分类1', 10003, 0, 100, 10001, 1563680747, 1563680747),
(10005, '子分类1', 10002, 10002, 100, 10001, 1563680760, 1563680791);
...
INSERT INTO `yoshop_delivery` (`delivery_id`, `name`, `method`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '包邮', 10, 100, 10001, 1563680484, 1563680484);
...
INSERT INTO `yoshop_goods` (`goods_id`, `goods_name`, `category_id`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '测试商品1', 10001, 10, 20, '&lt;p&gt;这是商品详情信息哈。。。&lt;/p&gt;', 66, 0, 100, 10001, 10, 0, 10001, 1563680561, 1563680561),
(10002, '测试商品2', 10002, 10, 10, '', 99, 0, 100, 10001, 10, 0, 10001, 1563680625, 1563680625);
...
(10001, 10001, 10001, 10001, 1563680561),
(10002, 10001, 10002, 10001, 1563680561),
(10003, 10002, 10002, 10001, 1563680625),
(10004, 10002, 10001, 10001, 1563680625);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_goods_spec`
--
...
--
-- 转存表中的数据 `yoshop_goods_spec`
--

INSERT INTO `yoshop_goods_spec` (`goods_spec_id`, `goods_id`, `goods_no`, `goods_price`, `line_price`, `stock_num`, `goods_sales`, `goods_weight`, `wxapp_id`, `spec_sku_id`, `create_time`, `update_time`) VALUES
(10001, 10001, '', '1.00', '1.90', 10, 0, 1, 10001, '', 1563680561, 1563680561),
(10002, 10002, '', '2.00', '2.90', 99, 0, 1, 10001, '', 1563680625, 1563680912);
...
INSERT INTO `yoshop_order` (`order_id`, `order_no`, `total_price`, `pay_price`, `pay_status`, `pay_time`, `express_price`, `express_company`, `express_no`, `delivery_status`, `delivery_time`, `receipt_status`, `receipt_time`, `order_status`, `transaction_id`, `user_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '2019072148501009', '2.00', '2.00', 20, 0, '0.00', '', '', 10, 0, 10, 0, 10, '', 10001, 10001, 1563680912, 1563680912);
...
(10001, '测试', '13816881688', 1, 2, 3, '测试', 10001, 10001, 10001, 1563680912);
...
INSERT INTO `yoshop_order_goods` (`order_goods_id`, `goods_id`, `goods_name`, `image_id`, `deduct_stock_type`, `spec_type`, `spec_sku_id`, `goods_spec_id`, `goods_attr`, `content`, `goods_no`, `goods_price`, `line_price`, `goods_weight`, `total_num`, `total_price`, `order_id`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10002, '测试商品2', 10002, 10, 10, '', 10002, '', '', '', '2.00', '2.90', 1, 1, '2.00', 10001, 10001, 10001, 1563680912);
...
('sms', '短信设置', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"","AccessKeySecret":"","sign":"","order_pay":{"is_enable":"0","template_code":"","accept_phone":""}}}}', 10001, 1530265122),
('storage', '上传设置', '{"default":"local","engine":{"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":""}}}', 10001, 1529926348),
('store', '商城设置', '{"name":"\\u7f51\\u4e0a\\u8d2d\\u7269\\u7cfb\\u7edf"}', 10001, 1563679626),
('trade', '交易设置', '{"order":{"close_days":"0","receive_days":"15","refund_days":"0"},"freight_rule":"10"}', 10001, 1530265122);
...
INSERT INTO `yoshop_store_user` (`store_user_id`, `user_name`, `password`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'admin', '9c4cb25665cf08667c815420ab383cb5', 10001, 1529926348, 1563681366);
...
INSERT INTO `yoshop_upload_file` (`file_id`, `storage`, `group_id`, `file_url`, `file_name`, `file_size`, `file_type`, `extension`, `is_delete`, `wxapp_id`, `create_time`) VALUES
(10001, 'local', 0, '', '2019072111393084f365525.png', 9502, 'image', 'png', 0, 10001, 1563680370),
(10002, 'local', 0, '', '20190721113934773365612.png', 4553, 'image', 'png', 0, 10001, 1563680375);
...
INSERT INTO `yoshop_user` (`user_id`, `open_id`, `nickName`, `avatarUrl`, `gender`, `country`, `province`, `city`, `address_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'oVZ3z0JZGJYOEQTAlOiI8iKFCVY0', '树懒飚起来', 'https://wx.qlogo.cn/mmopen/vi_32/KKZtrqzhGZs1n3N9ZbPiaIubnqSbo7PMnZx8Yw9iaG0h8ZAYPH7uqqwlSOKUzuw0LonL0I9XhVCrPib5QOQKh54Og/132', 1, '澳大利亚', '昆士兰', '黄金海岸', 10001, 10001, 1563680109, 1563680907);
...
INSERT INTO `yoshop_user_address` (`address_id`, `name`, `phone`, `province_id`, `city_id`, `region_id`, `detail`, `user_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '测试', '13816881688', 1, 2, 3, '测试', 10001, 10001, 1563680907, 1563680907);
...
INSERT INTO `yoshop_wxapp` (`wxapp_id`, `app_name`, `app_id`, `app_secret`, `is_service`, `service_image_id`, `is_phone`, `phone_no`, `phone_image_id`, `mchid`, `apikey`, `create_time`, `update_time`) VALUES
(10001, '网上购物系统', 'wx8e611909b290adb7', '09ec03c04e54eb460cbb7d9d1baeac34', 0, 0, 0, '', 0, '', '', 1529926348, 1563680102);
...
(10001, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10001, 1529926348, 1529926348);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_navbar`
--
...
--
-- 转存表中的数据 `yoshop_wxapp_navbar`
--

INSERT INTO `yoshop_wxapp_navbar` (`wxapp_id`, `wxapp_title`, `top_text_color`, `top_background_color`, `create_time`, `update_time`) VALUES
(10001, '网上购物系统', 20, '#00a92c', 1529926348, 1529936495);
